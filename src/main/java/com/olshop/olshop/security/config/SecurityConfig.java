package com.olshop.olshop.security.config;


import com.olshop.olshop.security.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/api/v1/engine/register").permitAll()
                        .requestMatchers("/api/v1/engine/user/**").permitAll()
                        .requestMatchers("/api/v1/engine/update/profile/**").permitAll()
